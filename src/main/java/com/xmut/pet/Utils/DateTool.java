...
public class DateTool {
    ...
    public final static String NOTIME="yyyyMMddHHmmss";
    ...
    private static SimpleDateFormat NoFormat = new SimpleDateFormat(NOTIME);
    ...
    public static String getCurrNoTime() {
        Calendar calendar = Calendar.getInstance();
        return NoFormat.format(calendar.getTime());
    }
